...
├⍟ Mʏ Nᴀᴍᴇ : <a SASUKE-NARUTO >name </a>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/ANIMEUNIVERSETEUGU">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a herf="https://t.me/ANIMEUNIVERSETEUGU">[ANIMEUNIVERSE_Botz]</a></b>"""
...
‼️ 𝑨𝒇𝒕𝒆𝒓 𝑺𝒆𝒏𝒅𝒊𝒏𝒈 𝑨 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝑷𝒍𝒆𝒂𝒔𝒆 𝑮𝒊𝒗𝒆 𝒖𝒔 𝒔𝒐𝒎𝒆 𝑻𝒊𝒎𝒆 𝑻𝒐 𝑨𝒅𝒅 𝒀𝒐𝒖 𝑰𝒏 𝑻𝒉𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑳𝒊𝒔𝒕.</b>"""    
    ...
    SOURCE_TXT ="""<b>PAID BROO! : 👇 </b>

 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a CONTACT DEVELOPER</a>\n """
